...
public class ICCEntryPointSourceSink {
	...
	public static void init() {
		...
		data.add(
				"<android.content.ContextThemeWrapper: void onActivityResult(int,int,android.content.Intent)> -> _SOURCE_");
		...
		data.add(
				"<java.net.URLConnection: void setRequestProperty(java.lang.String,java.lang.String)>  android.permission.INTERNET -> -> _SINK_");
